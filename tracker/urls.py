...
from PManager.viewsExt.projects import projectDetailEdit, projectDetailServer, projectDetail, projectDetailPublic, addInterface, removeInterface, checkUniqRepNameResponder, \
