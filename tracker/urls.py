...
from PManager.viewsExt.projects import projectList, projectDetailAjax, projectDetailAdd, projectDetailEdit, projectDetailServer, projectDetail, projectDetailPublic, addInterface, removeInterface, checkUniqRepNameResponder, \
