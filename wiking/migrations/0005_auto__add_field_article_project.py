...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.project'
        db.add_column(u'wiking_article', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, related_name='wiki_articles', to=orm['PManager.PM_Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.project'
        db.delete_column(u'wiking_article', 'project_id')
    ...
    models = {
        ...
        'wiking.article': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'wiki_articles'", 'to': "orm['PManager.PM_Project']"}),
