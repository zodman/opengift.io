...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleVersion.comment'
        db.add_column(u'wiking_articleversion', 'comment',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleVersion.comment'
        db.delete_column(u'wiking_articleversion', 'comment')
