...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wiking_articleversion', (
        ...
        db.send_create_signal('wiking', ['ArticleVersion'])

        # Adding model 'Article'
        db.create_table(u'wiking_article', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('head', self.gf('django.db.models.fields.related.ForeignKey')(related_name='article', to=orm['wiking.ArticleVersion'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='created_articles', to=orm['auth.User'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='childs', null=True, to=orm['wiking.Article'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('wiking', ['Article'])


    def backwards(self, orm):
        # Deleting model 'ArticleVersion'
        db.delete_table(u'wiking_articleversion')

        # Deleting model 'Article'
        db.delete_table(u'wiking_article')
