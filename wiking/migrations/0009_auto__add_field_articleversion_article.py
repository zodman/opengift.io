...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleVersion.article'
        db.add_column(u'wiking_articleversion', 'article',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['wiking.Article']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleVersion.article'
        db.delete_column(u'wiking_articleversion', 'article_id')
    ...
    models = {
        ...
        'wiking.article': {
            ...
            'head': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'head_article'", 'to': "orm['wiking.ArticleVersion']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
