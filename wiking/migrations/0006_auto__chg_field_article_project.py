...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.project'
        db.alter_column(u'wiking_article', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['PManager.PM_Project']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Article.project'
        raise RuntimeError("Cannot reverse this migration. 'Article.project' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Article.project'
        db.alter_column(u'wiking_article', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['PManager.PM_Project']))
