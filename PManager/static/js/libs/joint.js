...
// Copyright ┬й 2012 - 2014 client IO (http://client.io)
...
(function (root, factory) {
    ...
    var bezier = {
        ...
        // a parametric curve x = x(t)/w(t), y = y(t)/w(t), ямБnd the parameter value t
        ...
        getCurveDivider: function (p0, p1, p2, p3) {
            return function divideCurve(t) {
                ...
                return [
                    { p0: p0, p1: l, p2: p, p3: r },
                    { p0: r, p1: q, p2: n, p3: p3 }
                ];
            }
        }
    };
...
joint.shapes.devs = {}, joint.shapes.devs.Model = joint.shapes.basic.Generic.extend(_.extend({}, joint.shapes.basic.PortsModelInterface, {
    ...
    joint.shapes.devs.PathView = joint.dia.ElementView.extend(joint.shapes.basic.PortsViewInterface),
    joint.shapes.devs.AtomicView = joint.shapes.devs.ModelView,
    joint.shapes.devs.CoupledView = joint.shapes.devs.ModelView,
    "object" == typeof exports && (module.exports = joint.shapes.devs);